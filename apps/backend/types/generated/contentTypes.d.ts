...
export interface ApiToolTool extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::tool.tool", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::tool.tool", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
